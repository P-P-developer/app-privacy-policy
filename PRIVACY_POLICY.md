...
| Berechtigung                                | Zweck                                                                                  |
| ------------------------------------------- | -------------------------------------------------------------------------------------- |
| **Speicherzugriff (READ_EXTERNAL_STORAGE)** | Ermöglicht den Import von Datenbank-Backups zur Wiederherstellung Ihrer Trainingsdaten |
...
| Permission                                 | Purpose                                                         |
| ------------------------------------------ | --------------------------------------------------------------- |
| **Storage Access (READ_EXTERNAL_STORAGE)** | Allows importing database backups to restore your training data |
